...
export const routes: Routes = [
  ...
  {
    path: 'newsletter', loadComponent: () => import('./newsletter/newsletters.component')
  },
  {
    path: 'newsletter/:timestamp', loadComponent: () => import('./newsletter/newsletter/newsletter.component')
  },
];
